...
\begin{table}[htbp]
    ...
    \begin{tabular}{p{2.7cm}p{3.6cm}p{3.0cm}ccc}
        ...
        \midrule
        \multirow{2}{2.6cm}{Svanstr\"om (visible video)} & Svanstr\"om 2021 (avg.\ over distance bins) & IoU@0.5, det.\ thr.\ 0.5, YOLOv2 @416 & ND & ND & 0.785 \\
                                                   & \textbf{This thesis (baseline RGB, S1)} & IoP@0.5, @1280 & 0.940 & 0.961 & 0.950 \\
        \midrule
        \multirow{2}{2.6cm}{Svanstr\"om (thermal video)}  & Svanstr\"om 2021 (avg.\ over distance bins) & IoU@0.5, det.\ thr.\ 0.5, YOLOv2 @256 & ND & ND & 0.760 \\
