...
\begin{table}[htbp]
    ...
    \begin{tabular}{p{4.0cm}lll}
        ...
        \textbf{This thesis} & RGB + IR (decision-level) & Trust classifier + per-frame distilled (\texttt{mlp\_v5}) confuser filter & Learned per-frame modality choice; suppression deferred downstream of detection \\
        \bottomrule
    \end{tabular}
\end{table}
