# Thesis audit — thesis_working.tex (2026-05-31)
...
- result-like numbers scanned: **988**
- matched to an eval value: **985**
- **not found (3)** — verify (stale/copied, OR derived/cited/aggregate):

| value | line | context |
|---|---|---|
| 27.5\% | 468 | The IR detector's training and in-distribution test corpus. 129{,}130 thermal frames split |
| 27.5\% | 490 | \textbf{Total}  & \textbf{129{,}130} & 83.5 / 9.1 / 7.4 split; 72.5\% positive / 27.5\% ne |
| 37.2\% | 1578 | The same cross-modal equivalence that the feature-space analysis established (\S\ref{sec:i |
...
_figures.csv updated (23 rows)._
