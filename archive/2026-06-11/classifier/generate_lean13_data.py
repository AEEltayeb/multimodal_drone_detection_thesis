...
Usage:
    python classifier/generate_lean13_data.py \
        --rgb-weights "training/weights/retrained_v2.pt" \
...
def main():
    ...
    ap.add_argument("--include-yt", action="store_true",
                    help="Also process legacy yt_*.mp4 confuser clips at gui/demo_outputs/")
    ap.add_argument("--yt-stride", type=int, default=3)
    ap.add_argument("--output-dir", default="models/routers/lean13")
    args = ap.parse_args()
