...
MODELS = {
    "baseline": str(Path(__file__).parent.parent / "models/rgb/Yolo26n_trained/weights/best.pt"),
    "hardneg_v3more": str(Path(__file__).parent.parent / "models/rgb/Yolo26n_hardneg_v3_more/weights/best.pt"),
    "retrained_v2": str(Path(__file__).parent.parent / "models/rgb/Yolo26n_retrained_v2/weights/best.pt"),
}
