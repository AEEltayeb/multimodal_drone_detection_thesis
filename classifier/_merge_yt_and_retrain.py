...
LEAN13_CSV = REPO / "classifier/fusion_models/lean13/fusion_dataset_lean13.csv"
YT_CSV = REPO / "classifier/fusion_models/lean13_yt_only/fusion_dataset_lean13.csv"
COMBINED_CSV = REPO / "classifier/fusion_models/lean13_yt/fusion_dataset_lean13_yt.csv"
...
def main():
    ...
    train_and_save(df, FEATURES_13, REPO / "classifier/fusion_models/lean13_yt", "lean13_yt")
    print("=== Retraining Lean-10 on combined dataset ===")
    train_and_save(df, FEATURES_10, REPO / "classifier/fusion_models/lean10_yt", "lean10_yt")
