...
Runs in seconds. Outputs:
  classifier/fusion_models/lean17/fusion_dataset_lean17.csv
"""
import json, re, sys
...
ANTIUAV_CACHE = REPO / "classifier/fusion_models/lean13/cache_antiuav.json"
SVAN_CACHE = REPO / "classifier/fusion_models/lean13/cache_svanstrom.json"
VIDEO_CACHE_DIR = REPO / "docs/analysis/full_pipeline_ablations/cache"
VIDEO_TAG = "selcom_1280_sz1280"
IR_TAG = "ir_grayscale_sz640"
OUT_DIR = REPO / "classifier/fusion_models/lean17"
