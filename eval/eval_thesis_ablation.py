...
# ── Paths ────────────────────────────────────────────────────────
RGB_BASELINE = str(REPO / "RGB model/Yolo26n_trained/weights/best.pt")
RGB_SELCOM   = str(REPO / "RGB model/Yolo26n_selcom_mixed_ft2_1280/weights/best.pt")
IR_V3B       = str(REPO / "models/IR_final_cleaned/weights/best.pt")
CLF_PATH     = REPO / "classifier/fusion_models/scene_aware_v3more_32feat/model.joblib"
RGB_FILTER   = str(REPO / "classifier/runs/patches/confuser_filter4_rgb_v2_backup.pt")
IR_FILTER    = str(REPO / "classifier/runs/patches/confuser_filter4_ir_v2_backup.pt")
