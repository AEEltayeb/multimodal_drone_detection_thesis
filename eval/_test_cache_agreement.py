...
cases = [
    ...
    ("antiuav", "baseline",
     ...
     "RGB model/Yolo26n_trained/weights/best.pt", 640),
    ("antiuav", "selcom_960",
     "antiuav_per_model/selcom_960",
     "RGB model/Yolo26n_selcom_mixed_ft2_1280/weights/best.pt", 960),
    ("selcom_val", "selcom_960",
     "selcom_val_holdout/selcom_960",
     "RGB model/Yolo26n_selcom_mixed_ft2_1280/weights/best.pt", 960),
    ("selcom_val", "baseline",
     "selcom_val_holdout/baseline",
     "RGB model/Yolo26n_trained/weights/best.pt", 1280),
]
