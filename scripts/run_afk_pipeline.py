...
RGB_WEIGHTS = "models/rgb/Yolo26n_selcom_mixed_ft2_1280/weights/best.pt"
...
LEAN13_DIR = REPO / "models/routers/lean13"
LEAN10_DIR = REPO / "models/routers/lean10"
LEAN19_DIR = REPO / "models/routers/lean19"
LEAN13_YT_DIR = REPO / "models/routers/lean13_yt"
LEAN10_YT_DIR = REPO / "models/routers/lean10_yt"

CLF_32 = REPO / "models/routers/retrained_v2_32feat/model.joblib"
CLF_40 = REPO / "models/routers/control_v3more_40feat/model.joblib"
...
def step2_generate_lean19():
    ...
    run([sys.executable, "classifier/generate_lean19_data.py",
         ...
         "--output-dir", "models/routers/lean19"],
...
CSV = REPO / "models/routers/lean19/fusion_dataset_lean19.csv"
...
train(df, F13, REPO/"models/routers/lean13_yt", "lean13_yt")
train(df, F10, REPO/"models/routers/lean10_yt", "lean10_yt")
""", encoding="utf-8")
...
def step5_eval_all():
    ...
    run([sys.executable, "eval/eval_classifier_3way.py",
         ...
         "--conf", "0.25",
         "--video-rgb-cache-tag", "selcom_1280_sz1280",
         "--clf-10", "models/routers/lean10/model.joblib",
         "--clf-13", "models/routers/lean13/model.joblib",
         "--clf-19", "models/routers/lean19/model.joblib",
         "--clf-32", str(CLF_32),
         "--clf-40", str(CLF_40),
         "--auv-cache",  "models/routers/lean19/cache_antiuav.json",
         "--svan-cache", "models/routers/lean19/cache_svanstrom.json"],
