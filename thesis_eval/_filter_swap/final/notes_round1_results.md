...
2026-06-17 23:53 | same Tier-1 cache + shipped stack as tier1_results.json
...
| ir_only +filt | 3775 | 132 | 3898 | 0.9662 | 0.492 | 0.652 [0.6481–0.6556] |
| both bare | 7432 | 174 | 241 | 0.9771 | 0.9686 | 0.9728 [0.9697–0.9757] |
| both +filt | 7429 | 168 | 244 | 0.9779 | 0.9682 | 0.973 [0.9698–0.9759] |
| routed[robust8] bare | 7408 | 141 | 265 | 0.9813 | 0.9655 | 0.9733 [0.9702–0.9762] |
| routed[robust8] +filt | 7405 | 136 | 268 | 0.982 | 0.9651 | 0.9734 [0.9702–0.9763] |
| routed[robust8-nr] bare | 7430 | 160 | 243 | 0.9789 | 0.9683 | 0.9736 [0.9705–0.9764] |
| routed[robust8-nr] +filt | 7427 | 154 | 246 | 0.9797 | 0.9679 | 0.9738 [0.9706–0.9767] |
...
| 16-32px | 938 | 0.9545 | 0.9168 | 0.9353 | 0.9556 | 0.9168 | 0.9358 |
| 32-64px | 2911 | 0.9714 | 0.9691 | 0.9702 | 0.9714 | 0.9691 | 0.9702 |
...
| bucket | n_gt | bare P | bare R | bare F1 | +filt P | +filt R | +filt F1 |
|---|---|---|---|---|---|---|---|
| <16px | 351 | 0.7173 | 0.7664 | 0.741 | 0.727 | 0.7664 | 0.7462 |
| 16-32px | 12731 | 0.9544 | 0.9244 | 0.9391 | 0.9544 | 0.9243 | 0.9391 |
| 32-64px | 43020 | 0.9789 | 0.9702 | 0.9745 | 0.979 | 0.9701 | 0.9745 |
...
|---|---|---|---|---|---|
| airplane | 3043 | 0.352 [0.3352–0.3687] | 0.3283 [0.3122–0.3444] | 0.0325 [0.0266–0.0391] | 0.0289 [0.0233–0.0355] |
| bird | 871 | 0.1217 [0.0999–0.1435] | 0.1079 [0.0872–0.1286] | 0.0138 [0.0069–0.0218] | 0.0103 [0.0046–0.0172] |
...
| bucket | n_gt | bare P | bare R | bare F1 | +filt P | +filt R | +filt F1 |
|---|---|---|---|---|---|---|---|
| <16px | 777 | 0.8854 | 0.955 | 0.9189 | 0.885 | 0.9009 | 0.8929 |
| 16-32px | 778 | 0.9697 | 0.9884 | 0.979 | 0.973 | 0.9717 | 0.9723 |
| 32-64px | 837 | 0.9675 | 0.9964 | 0.9818 | 0.9667 | 0.9725 | 0.9696 |
| >=64px | 223 | 0.9605 | 0.9821 | 0.9712 | 0.9841 | 0.8341 | 0.9029 |
...
| 16-32px | 989 | 0.3254 | 0.0829 | 0.1322 | 0.3227 | 0.0819 | 0.1306 |
| 32-64px | 595 | 0.7947 | 0.2017 | 0.3217 | 0.8069 | 0.1966 | 0.3162 |
| >=64px | 20 | 0.058 | 0.2 | 0.0899 | 0.0645 | 0.2 | 0.0976 |
