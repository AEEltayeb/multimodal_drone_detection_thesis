...
Output:
    RGB model/Yolo26n_freeze8/weights/{best,epoch0..N,last}.pt
    RGB model/Yolo26n_freeze8/inline_antiuav.csv

Usage:
    python "RGB model/finetune_freeze8_after.py"
    python "RGB model/finetune_freeze8_after.py" --no-wait    # start now
"""
