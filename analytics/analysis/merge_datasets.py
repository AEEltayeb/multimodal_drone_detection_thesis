"""
Merge dsetV9b1 into gold dataset after consensus cleaning.

Only adds images from dsetV9b1 that:
  1. Don't already exist in gold (no duplicates)
  2. Survived consensus cleaning (not in flagged list)
  3. Are not in the duplicates.csv remove list
